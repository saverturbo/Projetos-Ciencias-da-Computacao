...
/**
 * Esta classe cria a janela de exibição dos dados.
...
public class TelaExibir extends JFrame {
	...
	private JButton btnBuscar, btnEditar, btnDelete,btnSave, btnVoltar; 
	...
	public TelaExibir() {
		...
		try {
			...
			e.printStackTrace();
			GerJanelasFacade.gravarLog(e.toString(), 114, "TelaExibir");
		}
		try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			GerJanelasFacade.gravarLog(e.toString(), 121, "TelaExibir");
		}
		...
		try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			GerJanelasFacade.gravarLog(e.toString(), 129, "TelaExibir");
		}
		...
		btnDelete = new JButton("EXCLUIR",delete);
		...
		btnVoltar.setBounds(145, 550, 120, 50);
		btnDelete.setBounds(265, 450, 120, 50);
